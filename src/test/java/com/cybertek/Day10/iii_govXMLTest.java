...
public class iii_govXMLTest {
    ...
    @Test
    public void test2() {
        String path = "http://ergast.com/api/f1/drivers";

        XmlPath xmlPath =
                get(path).then().statusCode(200).extract().xmlPath();

        String givenName = xmlPath.getString("MRData.DriverTable.Driver[0].GivenName");
