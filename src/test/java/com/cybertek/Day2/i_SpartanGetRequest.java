...
public class i_SpartanGetRequest {
    String baseUrl = "http://54.89.215.84:8000";
    ...
    public void test() {
        ...
        System.out.println("Response type: " + response.contentType());
    ...
    /*
        ...
        */
    @DisplayName("Get the request to /api/hello")
    @Test
    public void test3() {
